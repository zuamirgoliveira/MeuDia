    ...
    <div class="container-fluid">
		<div class="container">
			...
			<div class='col-md-6 float-left'>
				<form class='form-inline border shadow p-3 mb-5 bg-white rounded' method="POST" action="../php/exibirRelatorio.php" id='formRelatorio'>
					<div class='form-group mb-2'>
						<label for="relatorio">Gerar relatório de atividades:</label>
					</div>
					<div class='form-group mx-sm-3 mb-2'>
						...
						<input type='submit' class='btn btn-primary mb-2' id='gerarRelatorio' value="Gerar">			
				</form>
			</div>
